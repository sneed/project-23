...
![Create Volume 1](images/create-volume1.png)
...
Run the command below to check if you already have a storageclass in your cluster <mark>kubectl get storageclass</mark>
